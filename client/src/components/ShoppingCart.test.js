...
test("plants item displayed", () => {
    const { getByText, debug } = render(<ShoppingCart cart={plantsData} />);
    const plantItemOne = getByText(/Peperomia Rosso/i);
    expect(plantItemOne).toBeInTheDocument();
